...
foreach ($user in $users) {
    ...
    <p>Please visit https://passwordreset.microsoftonline.com to change your password or Unlock Account.  Alternatively, on a Windows machine, you may press Ctrl-Alt-Del and select `"Change Password`".</p>

    <p>If you do not know your current password, <a href='https://passwordreset.microsoftonline.com'>click here to email a password reset link</a>.</p>

    <p>Thank you,<br>
    <br>
    ti@mafdtvm.com.br<br>
    <br>
    </p>
    "
