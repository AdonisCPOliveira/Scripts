...
###   O CODIGO DO ObjectID DEVE SER COLADO NA COLUNA 'C' DA PLANILHA 'ADDUSERTOGROUP.CSV'   ###
...
$users = Import-Csv ".\addusertogroup.csv" -Delimiter ';' #-> Alterar o delimiter para ; ou , de acordo com o resultado do salvamento no excel
